...
var mt = E([
  ...
  ir = b(/^data-[\-\w.\u00B7-\uFFFF]+$/),
  or = b(/^aria-[\-\w]+$/),
  lr = b(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
...
function _t() {
  ...
  var de = rr,
    ...
    Le = function (e) {
      ($ && $ === e) ||
        ((!e || I(e) !== 'object') && (e = {}),
        (e = U(e)),
        (P = xt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? (P = kt) : (P = e.PARSER_MEDIA_TYPE)),
        ...
        e.CUSTOM_ELEMENT_HANDLING &&
          ...
          (f.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),
        H && (Ee = !1),
        Q && (z = !0),
        G &&
          ((p = l({}, M(pt))),
        ...
        e.FORBID_CONTENTS && (W === qe && (W = U(W)), l(W, e.FORBID_CONTENTS, T)),
        Se && (p['#text'] = !0),
  ...
  var Ut = function (e) {
          ...
          : e.namespaceURI === te
            ? t.namespaceURI === w
              ...
              : t.namespaceURI === re
                ...
                : !!Me[r]
            : e.namespaceURI === w
              ? (t.namespaceURI === re && !tt[u]) || (t.namespaceURI === te && !et[u])
                ? !1
                : !Me[r] && (Ft[r] || !ae[r])
    ...
    V = function (e) {
      return I(y) === 'object'
        ? e instanceof y
        : e && I(e) === 'object' && typeof e.nodeType == 'number' && typeof e.nodeName == 'string';
    },
    C = function (e, t, r) {
      N[e] &&
        Kt(N[e], function (u) {
    ...
    nt = function (e) {
      var t;
      if ((C('beforeSanitizeElements', e, null), De(e) || _(/[\u0080-\uFFFF]/, e.nodeName))) return S(e), !0;
      var r = T(e.nodeName);
      if (
      ...
      return (e instanceof D && !Ut(e)) ||
        ((r === 'noscript' || r === 'noembed' || r === 'noframes') && _(/<\/no(script|embed|frames)/i, e.innerHTML))
        ? (S(e), !0)
        : (H &&
            e.nodeType === 3 &&
            ((t = e.textContent),
            ...
            (t = L(t, Te, ' ')),
            (t = L(t, ve, ' ')),
            e.textContent !== t && (q(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
            ...
            if (
              !(
                (ot(e) &&
                  ...
                  ((f.attributeNameCheck instanceof RegExp && _(f.attributeNameCheck, t)) ||
    ...
    (n.sanitize = function (i) {
      ...
      if ((ye || Le(e), (n.removed = []), typeof i == 'string' && (X = !1), X)) {
        ...
        (t = rt('<!---->')),
          ...
          (r.nodeType === 1 && r.nodeName === 'BODY') || r.nodeName === 'HTML' ? (t = r) : t.appendChild(r);
      else {

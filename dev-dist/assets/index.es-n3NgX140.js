import { c as Ma, _ as qa, g as Zu } from './index-BRmzGL-d.js';
var un = {},
  ln = {},
  ur,
  hn;
...
function Ba() {
  ...
  return (
    ...
    !o && e && ((s = e.match(/Edge\/(\d+)/)), (!s || s[1] >= 74) && ((s = e.match(/Chrome\/(\d+)/)), s && (o = +s[1]))),
    (dt = o),
    dt
  );
}
  ...
  return (
    (Dt.f = n
      ? r
        ? function (v, f, g) {
            if (
              (t(v), (f = i(f)), t(g), typeof v == 'function' && f === 'prototype' && 'value' in g && h in g && !g[h])
            ) {
              var d = o(v, f);
              d &&
                d[h] &&
                ((v[f] = g.value),
                (g = { configurable: l in g ? g[l] : d[l], enumerable: u in g ? g[u] : d[u], writable: !1 }));
            }
            return s(v, f, g);
          }
        : s
  ...
  var n = re(),
    ...
    y = (jt.exports = function (m, b, x) {
      v(h(b), 0, 7) === 'Symbol(' && (b = '[' + f(h(b), /^Symbol\(([^)]*)\).*$/, '$1') + ']'),
        x && x.getter && (b = 'get ' + b),
        x && x.setter && (b = 'set ' + b),
        (!t(m, 'name') || (a && m.name !== b)) && (i ? c(m, 'name', { value: b, configurable: !0 }) : (m.name = b)),
  ...
  return (
    (Ht = function (i, a, s, o) {
      ...
      if ((n(s) && r(s, l, o), o.global)) u ? (i[a] = s) : t(a, s);
        ...
        u
          ? (i[a] = s)
          : e.f(i, a, { value: s, enumerable: !1, configurable: !o.nonConfigurable, writable: !o.nonWritable });
      }
      return i;
    }),
    Ht
      ...
      c
        ...
        : d && d.now
          ...
          : y && !h
            ...
            : n.addEventListener && t(n.postMessage) && !n.importScripts && E && E.protocol !== 'file:' && !a(k)
...
function dh() {
  ...
  var n = le(),
      ...
      try {
        W
          ? ($ || (q.rejection === Ae && xr(q), (q.rejection = De)),
            W === !0 ? (Te = G) : (Oe && Oe.enter(), (Te = W(G)), Oe && (Oe.exit(), (or = !0))),
            Te === C.promise ? Ve(new U('Promise-chain cycle')) : (We = Ne(Te)) ? i(We, Te, _e, Ve) : _e(Te))
          : Ve(G);
      } catch (Or) {
        Oe && !or && Oe.exit(), Ve(Or);
      }
    ...
    Ue = function (C, q, G) {
      var $, W;
      B
        ? (($ = I.createEvent('Event')), ($.promise = q), ($.reason = G), $.initEvent(C, !1, !0), t.dispatchEvent($))
        : ($ = { promise: q, reason: G }),
  ...
  return n({ global: !0, constructor: !0, wrap: !0, forced: _ }, { Promise: R }), o(R, O, !1, !0), u(O), ln;
}
var ro = {},
  Bi,
  to;
...
`)) &&
          ...
          N
            ? R
              ? ((R.input = p(R.input, z)), (R[0] = p(R[0], z)), (R.index = O.lastIndex), (O.lastIndex += R[0].length))
              : (O.lastIndex = 0)
        ...
        return [
          ...
          function (U, I) {
            ...
            for (var De = '', Ae = 0, pe = 0; pe < H.length; pe++) {
              Q = H[pe];
              for (var ye = h(Q[0]), me = m(b(u(Q.index), N.length), 0), Ie = [], Ne, he = 1; he < Q.length; he++)
                S(Ie, _(Q[he]));
              var be = Q.groups;
              if (B) {
                var Ue = x([ye], Ie, me, N);
    ...
    (ya = function (O, _, V, P, M, w, k) {
      ...
      if (
        (L &&
          ...
          B !== Object.prototype &&
            B.next &&
            (!r && s(B) !== p && (o ? o(B, p) : i(B[m]) || h(B, m, E)), u(B, A, !0, !0), r && (v[A] = E))),
        g &&
          M === x &&
          j &&
          j.name !== x &&
      ...
      function (S, E, O) {
        ...
        return [
          ...
          function (V, P) {
            ...
            var R = s(M, RegExp),
              A = M.unicode,
              U = (M.ignoreCase ? 'i' : '') + (M.multiline ? 'm' : '') + (M.unicode ? 'u' : '') + (g ? 'g' : 'y'),
            ...
            for (var N = 0, L = 0, B = []; L < w.length; ) {
              ...
              var z = c(I, g ? m(w, L) : w),
                X;
              if (z === null || (X = p(u(I.lastIndex + (g ? L : 0)), w.length)) === N) L = o(w, L, A);
              else {
          ...
          (this.getHelpXML = function () {
            ...
            for (var l = 0; l < u.length; l++)
              try {
                ...
                (p.style.cssText =
                  'margin: 3px; border: 1px solid black; background:' + d.toHex() + '; color:' + d.toHex()),
...
function cf(n) {
  ...
  for (var r = 0; r < n.length; r++) {
    ...
    if (t.type === T.CLOSE_PATH) e += 'z';
      ...
      e += (t.relative ? 'c' : 'C') + t.x1 + ' ' + t.y1 + ' ' + t.x2 + ' ' + t.y2 + ' ' + t.x + ' ' + t.y;
...
function Ee() {
  ...
  for (var r = 0; r < n.length; r++)
    if (typeof n[r] != 'number')
      throw new Error('assertNumbers arguments[' + r + '] is not a number. ' + typeof n[r] + ' == typeof ' + n[r]);
  return !0;
}
var Ge = Math.PI;
function Ia(n, e, r) {
  ...
  var c = Math.pow(t, 2) * Math.pow(l, 2) + Math.pow(i, 2) * Math.pow(u, 2),
    v = (n.lArcFlag !== n.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(t, 2) * Math.pow(i, 2) - c) / c)),
    f = ((t * l) / i) * v,
    g = ((-i * u) / t) * v,
    ...
    return (
      ...
      i(function (f, g, d, p) {
        ...
        if (f.xRot !== void 0 && (o !== 1 || u !== 0 || l !== 0 || h !== 1))
          if (O === 0)
            delete f.rX, delete f.rY, delete f.xRot, delete f.lArcFlag, delete f.sweepFlag, (f.type = T.LINE_TO);
          else {
      ...
      return (
        ...
        i(function (h, c, v, f, g) {
          ...
          return (
            ...
            o &&
              h.type & T.CLOSE_PATH &&
              ((h.type = T.LINE_TO), (h.x = h.relative ? f - c : f), (h.y = h.relative ? g - v : g)),
            h.type & T.ARC &&
              (h.rX === 0 || h.rY === 0) &&
              ((h.type = T.LINE_TO), delete h.rX, delete h.rY, delete h.xRot, delete h.lArcFlag, delete h.sweepFlag),
            h
          );
        })
      );
          ...
          ? (function (h, c, v) {
              ...
              for (
                ...
                var _ = Iu(h.phi1, h.phi2, O / b),
                  ...
                  w = [Math.cos(_ * Le) - M * Math.sin(_ * Le), Math.sin(_ * Le) + M * Math.cos(_ * Le)],
                  k = w[0],
                  R = w[1],
                ...
                (f = B(k, R)),
                  ...
                  (x[O].y = d[1]),
                  h.relative &&
                    ((x[O].x1 -= S), (x[O].y1 -= E), (x[O].x2 -= S), (x[O].y2 -= E), (x[O].x -= S), (x[O].y -= E)),
                  (S = (p = [x[O].x, x[O].y])[0]),
                  (E = p[1]);
              }
              return x;
  ...
  gf = (function (n) {
    ...
    return (
      ...
      (e.prototype.finish = function (r) {
        if ((r === void 0 && (r = []), this.parse(' ', r), this.curArgs.length !== 0 || !this.canParseCommandOrComma))
                  ...
                  if (this.curNumber && this.curCommandType !== -1) {
                    ...
                    if (this.curCommandType === T.ARC) {
                      if (this.curArgs.length === 0 || this.curArgs.length === 1) {
                        if (0 > h)
                          throw new SyntaxError('Expected positive number, got "' + h + '" at index "' + s + '"');
                      } else if (
                        (this.curArgs.length === 3 || this.curArgs.length === 4) &&
                        this.curNumber !== '0' &&
                        this.curNumber !== '1'
                      )
                        throw new SyntaxError('Expected a flag, got "' + this.curNumber + '" at index "' + s + '"');
                    }
                    this.curArgs.push(h),
                          ...
                          : T.VERT_LINE_TO === this.curCommandType
                            ...
                            : this.curCommandType === T.MOVE_TO ||
                              ...
                              ? (a({
                                ...
                                T.MOVE_TO === this.curCommandType && (this.curCommandType = T.LINE_TO))
                      ...
                      if (l) (this.curNumber = o), (this.curNumberHasDecimal = !1);
                        ...
                        if (!this.canParseCommandOrComma)
                          throw new SyntaxError(
                            'Unexpected character "' + o + '" at index ' + s + '. Command cannot follow comma'
                          );
                        if (((this.canParseCommandOrComma = !1), o !== 'z' && o !== 'Z'))
                          if (o === 'h' || o === 'H')
                            (this.curCommandType = T.HORIZ_LINE_TO), (this.curCommandRelative = o === 'h');
                          else if (o === 'v' || o === 'V')
                            (this.curCommandType = T.VERT_LINE_TO), (this.curCommandRelative = o === 'v');
                          else if (o === 'm' || o === 'M')
                            (this.curCommandType = T.MOVE_TO), (this.curCommandRelative = o === 'm');
                          else if (o === 'l' || o === 'L')
                            (this.curCommandType = T.LINE_TO), (this.curCommandRelative = o === 'l');
                          else if (o === 'c' || o === 'C')
                            (this.curCommandType = T.CURVE_TO), (this.curCommandRelative = o === 'c');
                          else if (o === 's' || o === 'S')
                            (this.curCommandType = T.SMOOTH_CURVE_TO), (this.curCommandRelative = o === 's');
                          else if (o === 'q' || o === 'Q')
                            (this.curCommandType = T.QUAD_TO), (this.curCommandRelative = o === 'q');
                          else if (o === 't' || o === 'T')
                            (this.curCommandType = T.SMOOTH_QUAD_TO), (this.curCommandRelative = o === 't');
                          else {
                            if (o !== 'a' && o !== 'A')
                              throw new SyntaxError('Unexpected character "' + o + '" at index ' + s + '.');
...
function Sf(n, e, r, t, i, a) {
  ...
  for (var ge = 0; ge < t; ge++) {
    ...
    var fe = s[b],
      ...
      We = c * q;
    f = v;
    for (var or = 0; or < h; or++) (f.r = fe), (f.g = xe), (f.b = C), (f.a = q), (f = f.next);
...
var Lc = Object.freeze({ __proto__: null, offscreen: Ef, node: Rf });
function nr(n) {
...
class J {
  ...
  static parsePath(e) {
    for (var r = de(e), t = r.length, i = [], a = 0; a < t; a += 2) i.push(new J(r[a], r[a + 1]));
    return i;
  }
  angleTo(e) {
...
class Ur {
  constructor(e) {
    var { fetch: r = ql, window: t = Ml } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    (this.ctx = e),
      (this.FRAMERATE = 30),
    ...
    if (
      ...
      var d = Date.now(),
        ...
        m = () => {
          (d = Date.now()),
            (y = d - p),
            y >= g && ((p = d - (y % g)), this.shouldUpdate(i, o) && (this.render(e, a, s, u, l, h, c), f.runEvents())),
  ...
  render(e, r, t, i, a, s, o) {
    ...
    !r &&
      ...
      (g.hasValue() && ((f.width = g.getPixels('x')), f.style && (f.style.width = ''.concat(f.width, 'px'))),
      d.hasValue() && ((f.height = d.getPixels('y')), f.style && (f.style.height = ''.concat(f.height, 'px'))));
...
class _a {
  constructor() {
    var { fetch: e = Ff, DOMParser: r = Uf } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
class oe {
  ...
  toString() {
    return [Jf(this.fontStyle), this.fontVariant, ec(this.fontWeight), this.fontSize, Zf(this.fontFamily)]
      .join(' ')
      .trim();
  }
}
...
class Pe {
  ...
  sumCubic(e, r, t, i, a) {
    return (
      Math.pow(1 - e, 3) * r + 3 * Math.pow(1 - e, 2) * e * t + 3 * (1 - e) * Math.pow(e, 2) * i + Math.pow(e, 3) * a
    );
  }
...
class F extends T {
  ...
  getReflectedControlPoint() {
    ...
    if (e !== T.CURVE_TO && e !== T.SMOOTH_CURVE_TO && e !== T.QUAD_TO && e !== T.SMOOTH_QUAD_TO) return this.current;
    var {
        current: { x: r, y: t },
        control: { x: i, y: a },
      } = this,
...
class Y extends rr {
  ...
  static pathA(e) {
    ...
    var f =
      (o === u ? -1 : 1) *
      Math.sqrt(
        (Math.pow(i, 2) * Math.pow(a, 2) - Math.pow(i, 2) * Math.pow(c.y, 2) - Math.pow(a, 2) * Math.pow(c.x, 2)) /
  ...
  pathA(e, r) {
    var { pathParser: t } = this,
      { currentPoint: i, rX: a, rY: s, sweepFlag: o, xAxisRotation: u, centp: l, a1: h, ad: c } = Y.pathA(t),
      v = 1 - o ? 1 : -1,
      f = h + v * (c / 2),
    ...
    if (a) {
      for (
        var { unitsPerEm: s } = a.fontFace,
          ...
          v = de(t.getAttribute('dx').getString()),
          f = c.length,
          g = 0;
        g < f;
        g++
...
class mr extends rr {
  ...
  setContext(e) {
    ...
    var h = this.getAttribute('refX'),
      ...
      f = v.hasValue() ? de(v.getString()) : null,
    ...
    f && ((d = f[0]), (p = f[1])),
      ...
      this.node &&
        (!this.parent ||
          ((r = this.node.parentNode) === null || r === void 0 ? void 0 : r.nodeName) === 'foreignObject') &&
...
class sc extends K {
  ...
  createPattern(e, r, t) {
    ...
    (s.attributes.viewBox = new D(this.document, 'viewBox', this.getAttribute('viewBox').getValue())),
      (s.attributes.width = new D(this.document, 'width', ''.concat(i, 'px'))),
      (s.attributes.height = new D(this.document, 'height', ''.concat(a, 'px'))),
      (s.attributes.transform = new D(this.document, 'transform', this.getAttribute('patternTransform').getValue())),
    ...
    l.hasValue() && h.hasValue() && u.translate(l.getPixels('x', !0), h.getPixels('y', !0)),
      t.hasValue() ? (this.styles['fill-opacity'] = t) : Reflect.deleteProperty(this.styles, 'fill-opacity');
    for (var c = -1; c <= 1; c++)
      for (var v = -1; v <= 1; v++)
        u.save(),
...
class oc extends K {
  ...
  render(e, r, t) {
    if (r) {
      ...
      (u.type = this.type),
        (u.attributes.viewBox = new D(this.document, 'viewBox', this.getAttribute('viewBox').getValue())),
        ...
        (u.attributes.width = new D(this.document, 'width', this.getAttribute('markerWidth').getValue())),
        (u.attributes.height = new D(this.document, 'height', this.getAttribute('markerHeight').getValue())),
        (u.attributes.overflow = new D(this.document, 'overflow', this.getAttribute('overflow').getValue())),
        (u.attributes.fill = new D(this.document, 'fill', this.getAttribute('fill').getColor('black'))),
        (u.attributes.stroke = new D(this.document, 'stroke', this.getAttribute('stroke').getValue('none'))),
...
class Bl extends K {
  ...
  createGradient(e, r, t) {
    ...
    if (
      ...
      var v = new sn(o, null);
      (v.attributes.transform = new D(o, 'transform', this.getAttribute('gradientTransform').getValue())),
        (v.children = [c]);
      var f = new mr(o, null);
...
class lc extends Bl {
  ...
  getGradient(e, r) {
    ...
    var a = t ? i.x + i.width * this.getAttribute('x1').getNumber() : this.getAttribute('x1').getPixels('x'),
      s = t ? i.y + i.height * this.getAttribute('y1').getNumber() : this.getAttribute('y1').getPixels('y'),
      o = t ? i.x + i.width * this.getAttribute('x2').getNumber() : this.getAttribute('x2').getPixels('x'),
      u = t ? i.y + i.height * this.getAttribute('y2').getNumber() : this.getAttribute('y2').getPixels('y');
...
class hc extends Bl {
  ...
  getGradient(e, r) {
    ...
    var a = t ? i.x + i.width * this.getAttribute('cx').getNumber() : this.getAttribute('cx').getPixels('x'),
      s = t ? i.y + i.height * this.getAttribute('cy').getNumber() : this.getAttribute('cy').getPixels('y'),
      o = a,
      u = s;
    this.getAttribute('fx').hasValue() &&
      (o = t ? i.x + i.width * this.getAttribute('fx').getNumber() : this.getAttribute('fx').getPixels('x')),
      this.getAttribute('fy').hasValue() &&
        (u = t ? i.y + i.height * this.getAttribute('fy').getNumber() : this.getAttribute('fy').getPixels('y'));
    var l = t ? ((i.width + i.height) / 2) * this.getAttribute('r').getNumber() : this.getAttribute('r').getPixels(),
...
class on extends K {
  ...
  update(e) {
    var { parent: r } = this,
      t = this.getProperty();
    if (
      (this.initialValue || ((this.initialValue = t.getString()), (this.initialUnits = t.getUnits())),
...
class bc extends ze {
  ...
  findSegmentToFitChar(e, r, t, i, a, s, o, u, l) {
    ...
    if (o) {
      var y = Math.cos(Math.PI / 2 + p) * o,
        m = Math.cos(-p) * o;
      (d.p0 = Er(Er({}, f), {}, { x: f.x + y, y: f.y + m })), (d.p1 = Er(Er({}, g), {}, { x: g.x + y, y: g.y + m }));
    }
  ...
  setTextData(e) {
    if (!this.glyphInfo) {
      ...
      (o === 'middle' || o === 'center') && (b = -p / 2),
        ...
        (b += m),
        t.forEach((x, S) => {
          var { offset: E, segment: O, rotation: _ } = this.findSegmentToFitChar(e, o, p, y, i, b, s, x, S);
          (b = E), !(!O.p0 || !O.p1) && this.glyphInfo.push({ text: t[S], p0: O.p0, p1: O.p1, rotation: _ });
        });
    }
  }
  parsePathData(e) {
    ...
    for (t.reset(); !t.isEnd(); ) {
      ...
      o.type !== F.CLOSE_PATH
        ? r.push({ type: u, points: l, start: { x: a, y: s }, pathLength: this.calcLength(a, s, u, l) })
  ...
  calcLength(e, r, t, i) {
    ...
    switch (t) {
      ...
      case F.CURVE_TO:
        for (
          a = 0, s = this.getPointOnCubicBezier(0, e, r, i[0], i[1], i[2], i[3], i[4], i[5]), u = 0.01;
          u <= 1;
          u += 0.01
        )
  ...
  getPathLength() {
    return (
      this.pathLength === -1 &&
        (this.pathLength = this.dataArray.reduce((e, r) => (r.pathLength > 0 ? e + r.pathLength : e), 0)),
      this.pathLength
    );
  }
...
class Ul extends K {
  ...
  apply(e, r, t, i, a) {
    for (var { includeOpacity: s, matrix: o } = this, u = e.getImageData(0, 0, i, a), l = 0; l < a; l++)
      for (var h = 0; h < i; h++) {
        var c = Rr(u.data, h, l, i, a, 0),
          v = Rr(u.data, h, l, i, a, 1),
          f = Rr(u.data, h, l, i, a, 2),
...
class hr {
  ...
  render() {
    ...
    return je(function* () {
      ...
      r.start(Xe({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, t)), yield r.ready(), r.stop();
    })();
  }
  start() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
